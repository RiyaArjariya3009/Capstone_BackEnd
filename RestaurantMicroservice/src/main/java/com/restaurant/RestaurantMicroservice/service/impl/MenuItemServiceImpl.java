...
public class MenuItemServiceImpl implements MenuItemService {
    ...
    public CommonResponseDto updateMenuItem(
        ...
        if (!menuItem.getFoodName().equals(menuItemupdateInDTO.getFoodName())) {
            // Check if a menu item with the same name exists in the restaurant, excluding the current item
            boolean menuItemExists = menuItemRepository.existsByFoodNameAndRestaurantId(menuItemupdateInDTO.getFoodName(),
                    restaurantId);
        ...
        menuItem.setFoodName(menuItemupdateInDTO.getFoodName());
